...
public class SucursalControlador implements SucursalRepository {
	...
	public LinkedList<Sucursal> getAllSucursal() {
	    ...
	    try {
	        ...
	        while (resultSet.next()) {
	            Sucursal sucursal = new Sucursal(resultSet.getInt("ID_Sucursal"),resultSet.getString("Direccion"),resultSet.getInt("Telefono"));
	...
	public void addSucursal(Sucursal sucursal) {
	    try {
	        ...
	        statement.setInt(3, sucursal.getTelefono());
