...
public class ClienteEntrenador extends JFrame {
    ...
    public ClienteEntrenador(Admin administrador, Entrenador entrenador) {
        ...
        btnAgregar.setBounds(46, 498, 338, 52);
        ...
        btnAtras.setBounds(802, 498, 345, 52);
        contentPane.add(btnAtras);
        
        JButton btnEditar = new JButton("Editar");
        btnEditar.setBounds(428, 498, 345, 52);
    ...
    public void actualizarTabla(int sucursal) { 
        ...
        for (Cliente cliente : clientes) {
            ...
            if (cliente.getId_entrenador() == entrenador.getId_entrenador() || cliente.getId_entrenador() ==0 && cliente.getEstado_sus().equalsIgnoreCase("Activa")) {
